...
# info
clear
echo "Auto Installer Modified By CodedEmax Team" | tee log-install.txt
...
echo "./mrtg-user.sh"	| tee -a log-install.txt
echo "./mrtg-mem.sh"	| tee -a log-install.txt
echo "./bench-network.sh"	| tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "Account Default (for SSH And VPN)"  | tee -a log-install.txt
echo "---------------"  | tee -a log-install.txt
echo "User     : emax"  | tee -a log-install.txt
echo "Password : $PASS"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "Functions"  | tee -a log-install.txt
echo "----------"  | tee -a log-install.txt
...
echo ""  | tee -a log-install.txt
echo "Emax SSH service REBOOT VPS !"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
echo "==============================================="  | tee -a log-install.txt